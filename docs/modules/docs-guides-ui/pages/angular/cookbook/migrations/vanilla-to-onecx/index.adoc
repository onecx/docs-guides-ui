...
[#further-reading]
== Further Reading
For more information on how OneCX loads microfrontends and utilizes web components for content rendering, refer to the xref:documentation:docs-guides-ui:module-federation/microfrontend-content-loading.adoc[Microfrontend Content Loading in OneCX] and xref:documentation:docs-guides-ui:module-federation/webcomponents.adoc[Web Components in OneCX] pages of the OneCX Docs.
