...
* xref:documentation:docs-guides-ui:angular/ngrx/search-criteria/calendar.adoc[Calendar input field]
* xref:documentation:docs-guides-ui:angular/ngrx/search-criteria/dropdown.adoc[Dropdown input field]
* xref:documentation:docs-guides-ui:angular/ngrx/search-criteria/multiselect.adoc[MultiSelect input field]
* xref:documentation:docs-guides-ui:angular/ngrx/search-criteria/autocomplete/autocomplete.adoc[AutoComplete input field]