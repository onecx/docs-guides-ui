...
[IMPORTANT]
====
Make sure to include the `appendTo="body"` property in the p-calendar component, otherwise the calendar will be rendered differently and will cause layout issues.
====
