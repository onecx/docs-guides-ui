...
For details on customizing the OneCX PrimeNG theme, see the xref:documentation:docs-guides-ui:features/primeng/theming-customization.adoc[PrimeNG Theming Customization] feature page for how the OneCX theme maps to PrimeNG and how to apply optional token overrides.
