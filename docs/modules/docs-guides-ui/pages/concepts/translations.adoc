...
NOTE: Once the Recommended Setup *Configure Translations* and *Expose Library Assets* pages are published, link them here as the practical step-by-step how-to for exposing application and library translations.
