...
NOTE: This page is Angular-only. There is currently no React equivalent — OneCX does not yet document a recommended state management pattern for React applications.
