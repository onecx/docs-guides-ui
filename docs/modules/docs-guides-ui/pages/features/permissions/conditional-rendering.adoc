...
* xref:documentation:docs-guides-ui:features/permissions/checking-permissions-in-code.adoc[Checking permissions in code] — the `UserService` checks for logic outside a template.
