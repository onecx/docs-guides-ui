...
NOTE: The current React approach for OneCX integration is experimental.
...
The implementation details live in the `@onecx/react-integration-functionalities` package (see xref:libraries/react-integration-functionalities.adoc[react-integration-functionalities]).
