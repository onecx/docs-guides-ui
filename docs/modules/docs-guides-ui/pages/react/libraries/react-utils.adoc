...
[#exports]
== Public Exports
The package exports the following public API from `libs/react-utils/src/lib/index.ts`:
...
[source,ts]
----
import { attachPrimeReactScoper } from '@onecx/react-utils';
...
[source,ts]
----
import applyThemeVariables from '@onecx/react-utils/src/lib/styling/theme/applyThemeVariables';
...
[source,css]
----
@import "../../libs/react-utils/src/lib/primeBaseTheme.scss";
----
