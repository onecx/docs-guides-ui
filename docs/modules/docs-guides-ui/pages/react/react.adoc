...
* Documentation: https://reactjs.org/docs/getting-started.html[Getting Started with React] 
* OneCX React Libraries Repository: xref:documentation:docs-guides-ui:react/libraries/react-integration-interface.adoc[OneCX React Libraries]
