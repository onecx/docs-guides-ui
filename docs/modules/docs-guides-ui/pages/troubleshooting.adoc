...
=== Improve debugging experience
To understand the root cause of issues, it is recommended to enable source maps in the application and shell during development. For more information on how to enable source maps, see xref:documentation:docs-guides-ui:features/development/source-maps.adoc[Source Maps].
