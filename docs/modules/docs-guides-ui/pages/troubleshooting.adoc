...
**Solution**:
To fix this, you need to configure Webpack to understand TypeScript path aliases. See xref:documentation:docs-guides-ui:ui-additional/configure-tsconfig-paths.adoc#tsconfig-paths-plugin[Webpack path aliases configuration].
