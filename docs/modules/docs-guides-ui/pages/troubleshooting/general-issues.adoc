...
Common issues arise when the shell and the application do not agree on what is shared. Review the required module federation setup in xref:documentation:docs-guides-ui:setup/required/expose-remote-module.adoc[Expose a Remote Module] and the share-scope setup in xref:documentation:docs-guides-ui:setup/required/configure-remote-package-sharing.adoc[Configure Remote Package Sharing].
