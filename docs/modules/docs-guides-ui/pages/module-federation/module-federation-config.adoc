...
This section focuses on the configuration of Microfrontends integrated with OneCX using Webpack's Module Federation.

== Module Federation with Webpack Explained
...
In the Angular example, there are multiple packages shared. All of them are related to OneCX.
