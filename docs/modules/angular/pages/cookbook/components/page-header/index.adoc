...
:details_page_cookbook: xref:latest@guides:angular:ngrx/cookbook/adding-details-page/details-page.adoc
:idprefix:
:idseparator: -
...
* Adding details page {details_page_cookbook}[cookbook]
