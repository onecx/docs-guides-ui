...
In order to update the state of the model, define reducer `+<feature>.reducers.ts+` file for your action:
...
In case your action needs to call som API, create an effect in `+<feature>.effects.ts+` file:
