...
:events_topic_url: xref:latest@documentation:javascript:libraries/integration-interface.adoc#events-topic
:current_mfe_topic_url: xref:latest@documentation:javascript:libraries/integration-interface.adoc#current-mfe-topic
:user_service_url: xref:latest@documentation:angular:libraries/angular-integration-interface.adoc#user-service
