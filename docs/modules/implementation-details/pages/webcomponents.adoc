...
OneCX platform offers different ways of xref:latest@general-information:general:architecture-overview/mfe.adoc[exposing Microfrontend's content]. One of them is **Webcomponent method**.
