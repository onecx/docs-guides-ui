...
OneCX platform offers different ways of xref:latest@documentation:general:architecture-overview/mfe.adoc[exposing Microfrontend's content]. One of them is **Webcomponent method**.
