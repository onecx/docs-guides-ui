...
OneCX platform offers different ways of xref:latest@documentation:onecx-docs-overview:architecture-overview/mfe.adoc[exposing Microfrontend's content]. One of them is **Webcomponent method**.
