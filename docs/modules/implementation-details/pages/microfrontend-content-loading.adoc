...
When dealing with modules, Shell UI is responsible for loading them. As explained in the xref:latest@documentation:general:architecture-overview/shell.adoc[Shell overview], Shell UI first constructs workspace and then handles routing and loading of remotes. Workspace configuration contains all valid routes to Applications registered for a given workspace, each route associated with a Microfrontend's module.
...
Remote Component loading is handled by the  Slot Component. The overall mechanism of Remote Component loading was explained in the xref:latest@documentation:general:architecture-overview/remote-components.adoc[Remote Components documentation]. In the context of content loading, it's important to note the following aspects:
...
[#useful-resources]
== Useful Resources
* xref:latest@documentation:general:architecture-overview/shell.adoc[Shell overview]
* xref:latest@documentation:general:architecture-overview/mfe.adoc[OneCX Microfrontend]
* xref:latest@documentation:general:architecture-overview/remote-components.adoc[OneCX Remote Components]
