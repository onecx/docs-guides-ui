:troubleshooting_shared_packages: xref:latest@documentation:guides:troubleshooting.adoc#shell-related
:troubleshooting_webpack_config: xref:latest@documentation:guides:troubleshooting.adoc#webpack-configuration
:troubleshooting_installed_packages: xref:latest@documentation:guides:troubleshooting.adoc#installed-packages
