...
|[.line-through]#id?# |[.line-through]#`string`# | Deprecated. Use `userId` instead.
...
|[.line-through]#tenantName?# |[.line-through]#`string`# | Deprecated. Use tenantId to determine user's tenant.
|===
+
[[UserPerson-object]]
